...
Dropped customerID as it is a non-predictive unique identifier.

Applied binary encoding to:
...
Applied one-hot encoding to remaining categorical features using pd.get_dummies().
...
<img width="1400" height="600" alt="image" src="https://github.com/user-attachments/assets/5122ce5b-9537-45b0-bc6b-e8546194247f" />
